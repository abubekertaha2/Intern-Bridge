...
//   return (
//     <div className="min-h-screen flex bg-[#1C274D] overflow-x-hidden relative">
//       {/* Left Panel */}
//       <div className="hidden lg:flex flex-col justify-center items-center p-8 w-1/2 bg-brand-dark text-brand-text relative">
//         <div className="absolute top-8 left-1/2 transform -translate-x-1/2">
//           <Logo />
//         </div>

//         <div className="mb-2 text-center flex justify-end flex-col items-center px-4">
//           <h1 className="text-3xl font-extrabold mb-3">
//             Bienvenido/a a PasantesRD
//           </h1>
//           <p className="text-base text-brand-subtle">
//             Conectando a los mejores talentos con las empresas líderes de la
...
//           {/* FAQ Button (same position, now functional) */}
...
//               <div>
//                 <h3 className="font-semibold text-[#1C274D]">
//                   ¿Qué es PasantesRD?
//                 </h3>
//                 <p>
