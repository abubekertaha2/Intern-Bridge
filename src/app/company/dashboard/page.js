...
export default function CompanyDashboardPage() {
  ...
  const validatePhone = (phone) => /^[\+]?[1-9][\d\s\-()]{7,15}$/.test(phone);
  ...
  return (
    <AuthLayout>
      <div className="flex flex-col gap-6 w-full max-w-6xl mx-auto px-2">
        <h2 className="text-4xl font-extrabold text-center text-[#1C274D]">Registro de Empresa</h2>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full p-3 border rounded-lg focus:outline-none ${errors.companyName ? "border-red-500" : "border-gray-300"}`}
            />
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              ...
              <select
                ...
                onChange={handleChange}
                className={`w-full p-3 border rounded-lg focus:outline-none ${errors.industry ? "border-red-500" : "border-gray-300"}`}
              >
            ...
            <div className="flex-1">
              ...
              <select
                ...
                onChange={handleChange}
                className={`w-full p-3 border rounded-lg focus:outline-none ${errors.companySize ? "border-red-500" : "border-gray-300"}`}
              >
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className={`w-full p-3 border rounded-lg focus:outline-none ${errors.description ? "border-red-500" : "border-gray-300"}`}
            />
          ...
          {/* Website */}
          <div>
            <label className="block font-semibold mb-1 text-[#1C274D]">Sitio Web (Opcional)</label>
            <input
              name="website"
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="Nombre"
                className={`w-full p-3 border rounded-lg focus:outline-none ${errors.contactName ? "border-red-500" : "border-gray-300"}`}
              />
            ...
            <div className="flex-1">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="Cargo"
                className={`w-full p-3 border rounded-lg focus:outline-none ${errors.contactPosition ? "border-red-500" : "border-gray-300"}`}
              />
              {errors.contactPosition && <p className="text-red-500 text-sm">{errors.contactPosition}</p>}
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1">
              ...
              <input
                ...
                className={`w-full p-3 border rounded-lg focus:outline-none ${errors.phone ? "border-red-500" : "border-gray-300"}`}
              />
          ...
          <div>
            ...
            <div
              ...
              className={`w-full p-3 border-2 border-dashed rounded-lg cursor-pointer flex items-center justify-center ${errors.logo ? "border-red-500 bg-red-50" : "border-gray-300 bg-[#CFE5FF]"}`}
            >
              {fileName}
            </div>
            <input
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="**********"
                className={`w-full p-3 border rounded-lg focus:outline-none ${errors.password ? "border-red-500" : "border-gray-300"}`}
              />
            ...
            <div className="flex-1">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="**********"
                className={`w-full p-3 border rounded-lg focus:outline-none ${errors.confirmPassword ? "border-red-500" : "border-gray-300"}`}
              />
...
//   const [fileName, setFileName] = useState("Subir logo de la empresa (JPG, PNG, PDF)");
//   const [companyLogoFile, setCompanyLogoFile] = useState(null); // State for the file object
//   const [errors, setErrors] = useState({});
//   const [loading, setLoading] = useState(false);
...
//     if (f) {
//         setFileName(f.name);
//         setCompanyLogoFile(f); // Store the file object
//     } else {
//         setFileName("Subir logo de la empresa (JPG, PNG, PDF)");
...
//     if (formData.password && formData.confirmPassword && formData.password !== formData.confirmPassword)
//       newErrors.confirmPassword = "Las contraseñas no coinciden";
//     if (!companyLogoFile) // Check the actual file object, not just the name
//       newErrors.logo = "El logo es obligatorio";
...
//     // Append the file with the name 'companyLogo'
//     if (companyLogoFile) {
...
//             // Redirect to the company profile using the ID from the API response
//             if (result.id) {
//                 router.push(`/company/profile/${result.id}`);
//             } else {
...
//               accept="image/jpeg,image/png,application/pdf"
//               onChange={handleFileChange}
//               name="companyLogo" // Corrected name attribute
//             />
//             {errors.logo && <p className="text-red-500 text-sm">{errors.logo}</p>}
//           </div>
